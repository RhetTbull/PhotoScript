...
#### [v0.5.3](https://github.com/RhetTbull/PhotoScript/compare/v0.5.2...v0.5.3)

> 22 December 2025

- Release 0.5.3 [`#65`](https://github.com/RhetTbull/PhotoScript/pull/65)
- Fix for selection in full screen preview, #63 [`#64`](https://github.com/RhetTbull/PhotoScript/pull/64)
- Add logging for selection error [`febfb3e`](https://github.com/RhetTbull/PhotoScript/commit/febfb3e4032fce48fc7164651d145eee246493d5)

#### [v0.5.2](https://github.com/RhetTbull/PhotoScript/compare/v0.5.1...v0.5.2)

> 7 November 2025

- Release v0.5.2 [`#62`](https://github.com/RhetTbull/PhotoScript/pull/62)
- Removed GH action [`666cdf4`](https://github.com/RhetTbull/PhotoScript/commit/666cdf4e8329ce5242aad341e255027411ef0456)
- release v0.5.1 files [`ef20f7c`](https://github.com/RhetTbull/PhotoScript/commit/ef20f7c810907867eb93332d87c0731388e11d18)
- release v0.5.2 files [`fea0943`](https://github.com/RhetTbull/PhotoScript/commit/fea09436ad0e203bced942c9e71715e78144efb4)
- Added AppleScript reference [`05250d6`](https://github.com/RhetTbull/PhotoScript/commit/05250d6f44c62b8a4e39bcf629a4c14e5184ffe3)

#### [v0.5.1](https://github.com/RhetTbull/PhotoScript/compare/v0.5.0...v0.5.1)

> 7 November 2025

- Move Album to Folder : added move method to Album [`#60`](https://github.com/RhetTbull/PhotoScript/pull/60)
- Applied black. [`#59`](https://github.com/RhetTbull/PhotoScript/issues/59)
- Added tests for: [`#59`](https://github.com/RhetTbull/PhotoScript/issues/59)
- Move Album to Folder [`#59`](https://github.com/RhetTbull/PhotoScript/issues/59)

#### [v0.5.0](https://github.com/RhetTbull/PhotoScript/compare/v0.4.0...v0.5.0)

> 3 November 2025

- Fix folders [`#61`](https://github.com/RhetTbull/PhotoScript/pull/61)
- test: add retry logic for AppleScript timeouts in run_script [`#58`](https://github.com/RhetTbull/PhotoScript/pull/58)
- Darwin 15.7.1 Support [`#54`](https://github.com/RhetTbull/PhotoScript/pull/54)
- Handle AppleScript timeout. Restart Photos. #52 [`#55`](https://github.com/RhetTbull/PhotoScript/pull/55)
- docs: add oPromessa as a contributor for code [`#56`](https://github.com/RhetTbull/PhotoScript/pull/56)
- Darwin 15.7.1 Support [`#53`](https://github.com/RhetTbull/PhotoScript/issues/53)
- andle AppleScript timeout and restart Photos to continue and retyr run_script once. Fixes #52 [`#52`](https://github.com/RhetTbull/PhotoScript/issues/52)
- Handle AppleScript timeout and restart Photos to continue and retyr run_script once. Fixes #52 [`#52`](https://github.com/RhetTbull/PhotoScript/issues/52)
- Fixed folder recursive walk on Sequoia [`4bec650`](https://github.com/RhetTbull/PhotoScript/commit/4bec650a4f1596807e7db63200140790f6d30feb)
- attemp to run tests on macos-26 [`ef698cd`](https://github.com/RhetTbull/PhotoScript/commit/ef698cdbdbe8fe586e986ed8cf85343fa39effaa)
- Built rery on Script Error eimedOut [`900f2bb`](https://github.com/RhetTbull/PhotoScript/commit/900f2bb00d30ea712467f407988aa44341330e1b)
- Added CI Actions tests.yml for non-interactive tests. [`451e0c7`](https://github.com/RhetTbull/PhotoScript/commit/451e0c7a88d09de39674a838dcbddaf6f59442de)
- macos-26: adjusted tests/photoscript_config_data.py [`b7acc52`](https://github.com/RhetTbull/PhotoScript/commit/b7acc52d93ab2b8caba343d5d0cb49ad481e5a17)

#### [v0.4.0](https://github.com/RhetTbull/PhotoScript/compare/v0.3.1...v0.4.0)

> 11 November 2024

- Release files for v0.4.0 [`#51`](https://github.com/RhetTbull/PhotoScript/pull/51)
- Py313uv [`#50`](https://github.com/RhetTbull/PhotoScript/pull/50)
- Initial port to uv [`d4cfee9`](https://github.com/RhetTbull/PhotoScript/commit/d4cfee926c257c952a7133b8e2042c486d74cc83)
- Removed poetry references [`f49e84e`](https://github.com/RhetTbull/PhotoScript/commit/f49e84e8bede64b3d33901e32c8fa03ad19758fa)
- Updated dev notes [`12b5c9e`](https://github.com/RhetTbull/PhotoScript/commit/12b5c9e47877dea5309ee99ecef9fc3063c52440)

#### [v0.3.1](https://github.com/RhetTbull/PhotoScript/compare/v0.3.0...v0.3.1)

> 22 October 2023

- docs: add anjos as a contributor for ideas, and bug [`#43`](https://github.com/RhetTbull/PhotoScript/pull/43)
- Updated for Python 3.12 [`706202f`](https://github.com/RhetTbull/PhotoScript/commit/706202f296ad7d7fa232f4c51c67d70fb7beb96a)
- Updated docs [`d08b081`](https://github.com/RhetTbull/PhotoScript/commit/d08b08119bb3ba003b99169c59f9d7c6e9196e52)
- Added reference to PyXA [`82ff729`](https://github.com/RhetTbull/PhotoScript/commit/82ff72947f95fc8372f0e0b3610c9c3410dc06fe)
- Updated docs [`3ca06e0`](https://github.com/RhetTbull/PhotoScript/commit/3ca06e0495b469c9a3bb93e5deb5d0900b8a0589)
- docs: update .all-contributorsrc [skip ci] [`c4ee36f`](https://github.com/RhetTbull/PhotoScript/commit/c4ee36fb67d48afead91d764b0ea37d0a441c9d0)

#### [v0.3.0](https://github.com/RhetTbull/PhotoScript/compare/v0.2.1...v0.3.0)

> 15 January 2023

- Bug slow folder lookup 36 [`#42`](https://github.com/RhetTbull/PhotoScript/pull/42)
- All tests passing on Ventura [`c2747db`](https://github.com/RhetTbull/PhotoScript/commit/c2747db34f7e47ffa889ca45b5691bef6cb60099)
- Updated bump2version [`2b9e760`](https://github.com/RhetTbull/PhotoScript/commit/2b9e7607d9e1ec2d0b0ae041f1c4cac122578185)
- Refactoring folder code to use folder script [`24a560c`](https://github.com/RhetTbull/PhotoScript/commit/24a560cf4a7518841f7dae253ebe93c0334f877f)
- More test fixes [`ac6bd42`](https://github.com/RhetTbull/PhotoScript/commit/ac6bd42112b2fda1145e4d12418a36c157033822)
- Removed unneeded AppleScript code [`6775b98`](https://github.com/RhetTbull/PhotoScript/commit/6775b98c76c1ed21abc5d30d67f7723ce4f18c76)

#### [v0.2.1](https://github.com/RhetTbull/PhotoScript/compare/v0.2.0...v0.2.1)

> 13 November 2022

- Bug version check locale 38 [`#39`](https://github.com/RhetTbull/PhotoScript/pull/39)
- Fix for #38, string to number in different locales [`e4e66d4`](https://github.com/RhetTbull/PhotoScript/commit/e4e66d4a441ef847b87f1717316f453bc3e3b0fe)
- Version bump [`a266968`](https://github.com/RhetTbull/PhotoScript/commit/a266968c0a1d3d49ab1664ec81ac10030d2bb08a)

#### [v0.2.0](https://github.com/RhetTbull/PhotoScript/compare/v0.1.6...v0.2.0)

> 12 November 2022

- Python 3.11 [`#37`](https://github.com/RhetTbull/PhotoScript/pull/37)
- Began refactor, added python 3.11 support [`4838773`](https://github.com/RhetTbull/PhotoScript/commit/48387733a08672d5aef5d4778144bb6f22b24a29)
- Updated docs [`1e7b621`](https://github.com/RhetTbull/PhotoScript/commit/1e7b6210d26606579180e2398f1ed83d34048756)
- Version bump [`96ba9b7`](https://github.com/RhetTbull/PhotoScript/commit/96ba9b7ac4eeb798dcb02523aef980b00b48ca54)

#### [v0.1.6](https://github.com/RhetTbull/PhotoScript/compare/v0.1.5...v0.1.6)

> 15 October 2022

- Updated docs [`#33`](https://github.com/RhetTbull/PhotoScript/pull/33)
- Refactor poetry [`#32`](https://github.com/RhetTbull/PhotoScript/pull/32)
- docs: add habi as a contributor for doc [`#27`](https://github.com/RhetTbull/PhotoScript/pull/27)
- Fix a typo [`#26`](https://github.com/RhetTbull/PhotoScript/pull/26)
- Updated build instructions [`34706f1`](https://github.com/RhetTbull/PhotoScript/commit/34706f1e971d8184b00517870af1b37da2a188a9)
- Updated install instructions [`f7e3101`](https://github.com/RhetTbull/PhotoScript/commit/f7e3101e67a3e16c2e36a65facf374158839d01e)
- Began refactor for poetry [`679bd1e`](https://github.com/RhetTbull/PhotoScript/commit/679bd1ea526b2447688fe0c7a413fde3ab228490)
- docs: create .all-contributorsrc [skip ci] [`4249d40`](https://github.com/RhetTbull/PhotoScript/commit/4249d40176de863c2149fd1d0b47d96aad90494d)
- docs: update README.md [skip ci] [`3593d5a`](https://github.com/RhetTbull/PhotoScript/commit/3593d5ac6819a9d42d2f8d7b139d63643843a7af)
