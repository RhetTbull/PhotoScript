...
def test_move_album_to_folder(photoslib):
    ...
    album = photoslib.album(ALBUM_1_NAME)  # album 'San Juan Capistrano' in folder 'Travel'
    ...
    assert sorted([ph.uuid for ph in moved_album.photos()]) == metadata_before["photos_uuids"]
